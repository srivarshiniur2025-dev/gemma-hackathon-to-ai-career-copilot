  ...
  return (
    <AccordionPrimitive.Header className="flex">
      <AccordionPrimitive.Trigger
        className={cn(
          "flex flex-1 cursor-pointer items-center justify-between py-5 text-left text-sm font-semibold transition-all hover:text-foreground-heading [&[data-state=open]>svg]:rotate-180",
          className
        )}
        {...props}
      >
